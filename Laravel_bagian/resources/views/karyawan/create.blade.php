          ...
          <div class="card">
            ...
            <form method="post" action="/karyawan">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('umur') is-invalid @enderror" id="umur" placeholder="Masukan Umur" name="umur">
                    @error('umur')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-check form-check-inline">
                    <input type="radio" class="form-check-input" name="jenis" id="jenis" value="Laki-laki" {{old('jenis') == 'Laki-laki' ?'checked' : ''}}>
                    <label for="Laki-laki" class="form form-check-input">Laki-laki</label>
                </div>
                <div class="form-check form-check-inline">
                    <input type="radio" class="form-check-input" name="jenis" id="jenis" value="Perempuan" {{old('jenis') == 'Perempuan' ?'checked' : ''}}>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('no_hp') is-invalid @enderror" id="no_hp" placeholder="Masukan No HP" name="no_hp">
                    @error('no_hp')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="jabatan_id" id="jabatan_id" class="form-control">
                        @foreach($jabatan as $jabatans)
                            <option value="{{$jabatans->id}}" {{old('jabatan_id') == "$jabatans->jabatan" ? 'selected' : ''}}>{{ $jabatans->jabatan }}
                            </option>
                        @endforeach
                    </select>
                    @error('jabatan_id')
                ...
                <div class="form-group">
                    ...
                    <select name="pendidikan_id" id="pendidikan_id" class="form-control">
                        @foreach($pendidikan as $pendidikans)
                            <option value="{{$pendidikans->id}}" {{old('pendidikan_id') == "$pendidikans->pendidikan" ? 'selected' : ''}}>{{ $pendidikans->pendidikan }}
                            </option>
                        @endforeach
                    </select>
                    @error('pendidikan_id')
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control @error('tgl_masuk') is-invalid @enderror" id="tgl_masuk" name="tgl_masuk">
                    @error('tgl_masuk')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
